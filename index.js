...
// PayPal Credentials (Galing sa iyo)
...
// Endpoint para gumawa ng Order
app.post('/payments/create', async (req, res) => {
    const { amount, description } = req.body;
    const formattedAmount = (amount / 100).toFixed(2); // Convert cents to USD (e.g. 500 -> 5.00)
    ...
    request.requestBody({
        ...
        application_context: {
            brand_name: "Pow.ai",
            user_action: "PAY_NOW",
            return_url: "powai://payment-success", // Babalik sa app
...
// Endpoint para i-verify at i-capture ang payment
